          ...
          <aside className="sidebar">
            ...
            <nav className="pt-8">
              <a href="#education" className="group flex items-center py-3 active">
                <svg class="w-6 h-6 text-slate-500 mr-4 group-hover:text-slate-200 group-focus-visible:text-slate-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
