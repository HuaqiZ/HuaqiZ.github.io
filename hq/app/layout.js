          ...
          <aside className="sidebar">
            ...
            <nav className="pt-8">
              <a href="#education" className="group flex items-center py-3 active">
                <svg className="w-6 h-6 text-slate-500 mr-4 group-hover:text-slate-200 group-focus-visible:text-slate-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" strokeLinecap="round" stroke-linejoin="round" strokeWidth="2" d="M8 20v-9l-4 1.125V20h4Zm0 0h8m-8 0V6.66667M16 20v-9l4 1.125V20h-4Zm0 0V6.66667M18 8l-6-4-6 4m5 1h2m-2 3h2"/>
                </svg>
              ...
              <a href="#experience" className="group flex items-center py-3 active">
                <svg className="w-6 h-6 text-slate-500 mr-4 group-hover:text-slate-200 group-focus-visible:text-slate-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" strokeLinecap="round" stroke-linejoin="round" strokeWidth="2" d="M8 7H5a2 2 0 0 0-2 2v4m5-6h8M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m0 0h3a2 2 0 0 1 2 2v4m0 0v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-6m18 0s-4 2-9 2-9-2-9-2m9-2h.01"/>
                </svg>
